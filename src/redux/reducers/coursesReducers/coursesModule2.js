...
const coursesModule2 = (state = intialState, { type, payload }) => {
  switch (type) {
    ...
    case ActionTypes.UPDATE_COURSE_MODULE_2_STATE:
    ...
    case ActionTypes.CHANGE_COURSE_MODULE_2:
    ...
    case ActionTypes.ERROR_UPDATE_COURSE_MODULE_2_STATE:
    case ActionTypes.ERROR_CHANGE_COURSE_MODULE_2:
