...
import { fetchEmailTemplateContent, 
  ...
  clearEmailReminder1DayState } from '../../../redux/actions/emailTemplatesActions/emailReminder1Day';
...
const EmailReminderCurs1zi = ({ setShowPlaceholder }) => {
  ...
  const emailTemplateContent = useSelector(state => state.emailReminder1Day.template)
  const getChangeEmailTemplateSuccess = useSelector(state => state.emailReminder1Day.success)
  const getChangeEmailTemplateServerMessage = useSelector(state => state.emailReminder1Day?.message)

  // get the server response after sending TEST E-mail Template
  const getNodeMailerResponse = useSelector(state => state.emailReminder1Day.emailResponse)
  const getTestEmailSuccess = useSelector(state => state.emailReminder1Day.success)
  const getTestEmailServerMessage = useSelector(state => state.emailReminder1Day?.message)
  ...
  useEffect( () => {
    if (getChangeEmailTemplateSuccess && getChangeEmailTemplateServerMessage && 
      getChangeEmailTemplateServerMessage === "E-MAIL TEMPLATE content successfully added") {
        ...
        dispatch(clearEmailReminder1DayState())
  ...
  //               <h6 className='ps-5 pe-5 subtitle'> E-mail reminder 1 zi înaintea începerii cursului modul 1 </h6>
